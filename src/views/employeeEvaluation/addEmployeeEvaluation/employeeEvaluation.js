...
const employeeEvaluation = ({}) => {
  ...
  const supervisorRecOptions = [
    {
      value: "I recommend promotion",
      label: "I recommend promotion",
      field: "supervisorRecommendations"
    },
    {
      value: "I recommend a raise",
      label: "I recommend a raise",
      field: "supervisorRecommendations"
    },
  ...
  const [teams, setTeams] = useState([
    {
      value: evaluationState?.isAddTeamDetails?.teamName,
      label: evaluationState?.isAddTeamDetails?.teamName,
  ...
  for (let i = 0; i < memberdata.length; i++) {
    tempArray.push({
      value: memberdata[i].employee.name,
      label: memberdata[i].employee.name,
      id: memberdata[i].employee.id
    });
  }
            ...
            <div className="form-card">
              ...
              <div className="row justify-content-between text-left">
                ...
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    options={Options}
                    onChange={(event) =>
                      handleChange(event, "employeeDiscipline")
                    }
                  ></Select>
                </div>
              </div>
              ...
              <div className="row justify-content-between text-left">
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    onChange={(event) =>
                      handleChange(event, "employeeWorkQuality")
                    }
                  ></Select>
                </div>
                <div className="form-group col-sm-6 flex-column d-flex">
              ...
              <div className="row justify-content-between text-left">
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    options={Options}
                    onChange={(event) =>
                      handleChange(event, "decisionMakingAbility")
                    }
                  ></Select>
                </div>
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    options={Options}
                    onChange={(event) =>
                      handleChange(event, "jobKnowledgeAndProficiency")
                    }
                  ></Select>
                </div>
              </div>
              ...
              <div className="row justify-content-between text-left">
                ...
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    options={Options}
                    onChange={(event) =>
                      handleChange(event, "involvementOfWorkerInTeamEffort")
                    }
                  ></Select>
                </div>
              </div>
              <div className="row justify-content-between text-left">
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    options={Options}
                    onChange={(event) =>
                      handleChange(event, "accomplishmentsOfJobDeadlines")
                    }
                  ></Select>
                </div>
                ...
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    onChange={(event) =>
                      handleChange(
                        event,
                        "receptivenessToChangingWorkEnvironment"
                      )
                    }
                  ></Select>
                </div>
              ...
              <div className="row justify-content-between text-left">
                ...
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <input
                    value={
                      evaluationState?.newEvaluation?.areasThatNeedsImprovement
                    }
                    onChange={handleInputFields}
                    type="text"
              ...
              <div className="row justify-content-between text-left">
                <div className="form-group col-sm-6 flex-column d-flex">
                  <label className="form-control-label px-3">
                    Based on the above text, Your suggestions please{" "}
                    <span className="text-danger"> *</span>
                  </label>{" "}
                  <input
                ...
                <div className="form-group col-sm-6 flex-column d-flex">
                  ...
                  <Select
                    ...
                    onChange={(event) =>
                      handleChange(event, "supervisorRecommendations")
                    }
                  ></Select>
                </div>
              </div>
