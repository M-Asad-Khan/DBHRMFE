              ...
              <div className="card" style={{ height: "338px" }}>
                <div className="row d-flex justify-content-center">
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div>{evaluationState?.newEvaluation?.decisionMakingAbility}</div>
                  </div>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div>{evaluationState?.newEvaluation?.jobKnowledgeAndProficiency}</div>
                  </div>
                  <div className="d-flex justify-content-between">
                    <div className="d-flex">
                    <FaUsersCog className="icon-design" />
                    ...
                    <div>{evaluationState?.newEvaluation?.involvementOfWorkerInTeamEffort}</div>
                  </div>
                  <div className="d-flex justify-content-between">
                    <div className="d-flex">
              ...
              <div className="card" style={{ height: "338px" }}>
                <div className="row d-flex justify-content-center">
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div>{evaluationState?.newEvaluation?.suggestions}</div>
                  </div>
